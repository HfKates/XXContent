...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ContentInter的一个简单示范工程示范工程的长描述.
                   DESC

  s.homepage     = "https://github.com/HfKates/XXContent"
  ...
  s.source       = { :git => "https://github.com/HfKates/XXContent.git", :tag => "#{s.version}" }
  ...
  s.subspec 'Core' do |core|
    ...
    core.vendored_frameworks = "XXContent.framework" 
    #core.public_header_files = "ZXXContentInteract.framework/Headers/*.h"
    core.resource_bundles = {
      "#{s.name}" => ["XXContentBundle/*.{jpg,png,xib,strings,plist,bundle}"]
    }
